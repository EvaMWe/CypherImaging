function [starts, stops, dF,trace_cut,nStim] = analyseTrace_forBl(trace,gradFilt,SE,cuttingWin,nStim,varargin)
if nargin == 6   %fixed value for first stim
...
number = nStim * 2; %edges for start and stop;
