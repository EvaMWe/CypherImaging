function [lambda,bleachingcurve] = createBleachingCurve(orig, range, cuttingWindow, nStim, varargin)
if nargin >= 5
    show = varargin{1};
else
    show = 1;
...
bleachingcurve.start=starts + cutWin;
bleachingcurve.stop=stops + cutWin;
bleachingcurve.curve=discrete;
bleachingcurve.curve_x=X;
bleachingcurve.curve_y=Y;
